...
abstract class AppLocalizations {
  ...
  /// Displayed when the AI wins a round.
  ///
  /// In en, this message translates to:
  /// **'AI wins!'**
  String get iaWin;

  /// Displayed when the user wins a round.
  ///
  /// In en, this message translates to:
  /// **'You win!'**
  String get userWin;
  ...
  /// Label for the AI's choice.
  ///
  /// In en, this message translates to:
  /// **'AI CHOICE'**
  String get iaChoice;

  /// Label for the user's choice.
  ///
  /// In en, this message translates to:
  /// **'YOUR CHOICE'**
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['de', 'en', 'es', 'fr', 'it', 'pt', 'ru', 'zh'].contains(locale.languageCode);
